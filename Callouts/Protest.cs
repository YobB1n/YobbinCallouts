//CALLOUT SCENARIOS - once player arrives on scene, (1) fight, (2) agression, (3) someone runs protesters over with vehicle...
...
{
    [CalloutInfo("[YC] Protest", CalloutProbability.High)]

    public class Protest : Callout
    {
        ...
        {
            Game.LogTrivial("YOBBINCALLOUTS: Protest Callout Accepted by User.");
        ...
        {
            Game.LogTrivial("YOBBINCALLOUTS: Protest Callout Not Accepted by User.");
        ...
        public override void End()
        {
            ...
            Game.LogTrivial("YOBBINCALLOUTS: Protest Callout Finished Cleaning Up.");
        }
